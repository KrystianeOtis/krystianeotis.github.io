...
async function getWeather() {
    ...
    const apiURL = 'https://api.openweathermap.org/data/2.5/weather?zip=83287&appid=953894ad13f71540f4d4ee5b185b63d7&units=imperial'; // url for the weather data api
    fetch(apiURL)
    ...
    const apiURL2 = 'https://api.openweathermap.org/data/2.5/forecast?zip=83287&units=imperial&appid=953894ad13f71540f4d4ee5b185b63d7'; // url for the weather data api
    fetch(apiURL2)
        .then((response) => response.json())
        .then((jsObject) => {
            console.log(jsObject);
